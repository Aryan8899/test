...
export default function Nav({ isOpen, setIsOpen }) {
  ...
  const [isCryptoDetailNavOpen, setIsCryptoDetailNavOpen] = useState(false);
  ...
  const handleOutsideClick = (e) => {
    if (e.target.id === 'outside-crypto-detail-nav') {
      setIsCryptoDetailNavOpen(false);
    }
  };
            ...
            <div className="container mx-auto px-4 py-2 flex justify-between items-center w-full">
              ...
              <div className="flex items-center space-x-4">
                <button
                  ...
                  data-testid="outside-crypto-detail-nav"
